...
SQL_FILES = [
    "sql/validation/01_profile_raw_data.sql",
    "sql/validation/02_validate_raw_to_validated.sql",
    "sql/validation/03_data_quality_checks.sql",
]
...
def main() -> None:
    ...
    logger.info("Starting RecoMart data profiling and validation pipeline")
    ...
    try:
        ...
        logger.info("RecoMart data validation completed successfully")

    except Exception as error:
        logger.error(f"Validation pipeline failed: {error}")
        raise
